...
//    	Log.d("LA", "uploadImagestart");
        ...
        Intent intent = new Intent(super.getActivity(), PostCreateActivity.class);
...
//    }
    ...
    private void parseLogin () {
        ...
        if (currentUser == null) {
            ...
            Intent intent = new Intent(super.getActivity(), ParseLoginActivity.class);
            startActivity(intent);
        } else {
            // seems like there is no reply callback
            Toast.makeText(super.getActivity(), "You are logged in.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void parseLogout () {
        ...
        ParseUser.logOut();
        Toast.makeText(super.getActivity(), "You are logged out.", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(super.getActivity(), ParseLoginActivity.class);
        startActivity(intent);
    }
